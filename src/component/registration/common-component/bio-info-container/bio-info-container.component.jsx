			...
			<div>
							...
							{educationalQualification?.sscOrEquivalentStudy === 'হ্যাঁ' && (
								<>
									...
									<tr>
										...
										<td>{educationalQualification?.sscOrEquivalentDivision}</td>
									</tr>
									<tr>
										...
										<>
											...
											{educationalQualification?.honsOrEquivalentStudy !==
												...
												<>
													...
													<tr>
														<td>পাসের সন</td>
														<td>{educationalQualification?.honsPassingYear}</td>
													</tr>
												</>
											)}
										</>
									...
									{educationalQualification?.hscOrEquivalentStudy ===
										...
										<>
											...
											<tr>
												<td>পাশের সন</td>
												<td>{educationalQualification?.diplomaPassingYear}</td>
											</tr>
										</>
									)}
								</>
							...
							{educationalQualification?.passDaorayeHadis === 'হ্যাঁ' && (
								<>
									<tr>
										...
										<td>{educationalQualification?.DaorayeHadisPassingYear}</td>
									</tr>
									<tr>
				...
				<table className='bio-info-table'>
					...
					<tr>
						...
						<td>{partnersCharacteristics?.partnersDesirableCharacteristics}</td>
					</tr>
				</table>
				...
				<table className='bio-info-table'>
					...
					<tr>
						<td>আল্লাহ'র শপথ করে সাক্ষ্য দিন, যে তথ্যগুলো দিচ্ছেন সব সত্য?</td>
